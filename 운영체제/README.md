...
운영체제 역할 3: 컴퓨터 하드웨어와 **응용 프로그램**을 제어

>운영체제의 목표 : 사용자가 사용하는 응용 프로그램이 효율적으로, 적절하게 동작하도록 지원
>운영페제는 응용 프로그램이 요청하는 시스템 리소스를 효율적으로 분배하고, 지원하는 소프트웨어
...
**정리**
```
1.운영체제의 역할: 시스템 자원,응용프로그램 관리, 효율적 분배
...
막대 : 시간축 /br
`application 1` : (가정)12시간정도 걸리는 프로그램이다./br
